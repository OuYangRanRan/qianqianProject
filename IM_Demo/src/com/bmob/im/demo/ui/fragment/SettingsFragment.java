...
import com.bmob.im.demo.ui.RegisterActivity;
import com.bmob.im.demo.ui.RegistryActivity;
...
public class SettingsFragment extends FragmentBase implements OnClickListener{
	...
	RelativeLayout layout_info, rl_switch_notification, rl_switch_voice,
			rl_switch_vibrate,layout_blacklist,layout_registry;
	...
	private void initView() {
		...
		layout_registry=(RelativeLayout) findViewById(R.id.layout_registry);
		...
		layout_registry.setOnClickListener(this);
	}
	...
	public void onClick(View v) {
		...
		case R.id.rl_switch_vibrate:
			...
			break;
			//点击签到的响应时间
		case R.id.layout_registry:
			Intent registry_Intent=new Intent();
			registry_Intent.setClass(getActivity(),RegistryActivity.class);//签到页面
			startActivity(registry_Intent);
		}
	}
